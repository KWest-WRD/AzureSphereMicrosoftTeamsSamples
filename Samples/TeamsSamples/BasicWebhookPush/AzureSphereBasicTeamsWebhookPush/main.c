...
/// </summary>
static void PerformWebhookPOST(void)
{
    ...
    if ((res = curl_easy_setopt(curlHandle, CURLOPT_URL, "https://outlook.office.com/webhook/YOUR_URL_HERE")) != CURLE_OK) {
	...
	if ((res = curl_easy_setopt(curlHandle, CURLOPT_POSTFIELDS, "{\"@context\": \"https://schema.org/extensions\", \"@type\": \"MessageCard\", \"title\" : \"Hello from Azure Sphere\", \"text\" : \"Sent from Azure Sphere!\"}")) != CURLE_OK) {
...
int main(int argc, char *argv[])
{
    ...
    Log_Debug("This sample periodically attempts to post an Adaptive Card to a Teams Webhook URL");
